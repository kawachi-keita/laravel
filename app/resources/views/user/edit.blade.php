                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update',['user'=>$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('storage/icon/' . Auth::user()->image) }}" class="img-circle" width="50" height="50">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="profile" class="form-control @error('profile') is-invalid @enderror" name="profile" required autocomplete="profile" autofocus>{{ old('profile',$user->profile) }}</textarea>
